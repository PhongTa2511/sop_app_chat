<template>
  <div>
    <v-row class="pr-3" style="height: calc(100vh - 112px)">
      <v-col :lg="8" cols="12" class="">
        <v-card class="layout-card">
          <v-card-title class="text-h6 py-2 pl-4 pr-0">
            ...
            <div class="mt-2 text-subtitle-1" v-if="dataJobInfo.StepOrder">
              <v-chip color="red">Bước {{ dataJobInfo.StepOrder }}</v-chip>
              {{ dataJobInfo.StepName }}
            </div>
            <div class="mt-2 text-subtitle-1" v-if="dataJobInfo.JobName">
              <v-chip color="green">Công việc</v-chip>
              {{ dataJobInfo.JobName }}
            </div>
            <div class="mt-2 text-subtitle-1" v-if="dataJobInfo.Note">
